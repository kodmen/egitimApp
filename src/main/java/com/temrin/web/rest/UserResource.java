...
import com.temrin.repository.UserRepository;
import com.temrin.security.AuthoritiesConstants;
import com.temrin.service.MailService;
...
import com.temrin.web.rest.errors.EmailAlreadyUsedException;
import com.temrin.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
public class UserResource {
 ...
 public ResponseEntity<AdminUserDTO> getUserSeacrh( @RequestParam(required = false) String seacrh) {
        ...
        final AdminUserDTO page = userService.getUserSeacrh(seacrh);
